      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Apotek Hada | Data Supplier</h4>
                </div>
                <div>
                <a class="btn btn-primary btn-icon-text btn-rounded" href="tambahsupplier.php">
                      <i class="ti-export btn-icon-prepend"></i>Tambah Supplier</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Data Supplier Yang Ada</h4>
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="editsupplier.php?id=<?php echo $data['id_supplier'] ?>" class="btn btn-success">Edit</a> 
                            <a href="deletesupplier.php?id=<?php echo $data['id_supplier'] ?>" class="btn btn-danger">Hapus</a>
                        </td>
                        </tr>
                        <?php $i++; ?>
                        <?php 
